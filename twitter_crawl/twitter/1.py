...
crawler = twitterpastcrawler.TwitterCrawler(
        query="#python",  # searches for tweets that respond to the query, "#haiku"
        output_file="python.csv"  # outputs results to haiku.csv
)

# crawler.crawl()  # commences the crawl

search_url = 'https://twitter.com/i/search/timeline'

import requests

url = 'https://api.twitter.com/2/search/adaptive.json?include_profile_interstitial_type=1&include_blocking=1&include_blocked_by=1&include_followed_by=1&include_want_retweets=1&include_mute_edge=1&include_can_dm=1&include_can_media_tag=1&skip_status=1&cards_platform=Web-12&include_cards=1&include_composer_source=true&include_ext_alt_text=true&include_reply_count=1&tweet_mode=extended&include_entities=true&include_user_entities=true&include_ext_media_color=true&include_ext_media_availability=true&send_error_codes=true&simple_quoted_tweets=true&q=python%20since%3A2019-01-17&count=20&query_source=typed_query&pc=1&spelling_corrections=1&ext=mediaStats%2ChighlightedLabel%2CcameraMoment'
